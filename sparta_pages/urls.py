...
urlpatterns = [
    ...
    url(r'^sparta/profile/info/(?P<pk>\d+)$', views.AdditionalEditPageView.as_view(), name='sparta-extended-profile-update'),
    ...
    url(r'^sparta/admin-view/inactivity/approve/(?P<username>[-\w]+)/(?P<course_key>[-:+\w]+)$', admin_views.admin_approve_unenrollment_view, name='sparta-unenrollment-approve'),
