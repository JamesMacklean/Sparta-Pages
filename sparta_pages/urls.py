...
urlpatterns = [
    ...
    url(r'^sparta/d/profile/education/(?P<pk>\d+)/$', views.EducationProfileDeleteView.as_view(), name='sparta-education-delete'),
    url(r'^sparta/d/profile/employment/(?P<pk>\d+)/$', views.EmploymentProfileDeleteView.as_view(), name='sparta-employment-delete'),
    url(r'^sparta/d/profile/training/(?P<pk>\d+)/$', views.TrainingProfileDeleteView.as_view(), name='sparta-training-delete'),
