...
class SpartaProfileForm(forms.Form):
    ...
    org = models.CharField(required=True, choices=SpartaProfile.ORG_CHOICES)
    ccap_sub = models.CharField(required=False, choices=SpartaProfile.CCAP_SUBCHOICES)
    lgu_sub = models.CharField(required=False, choices=SpartaProfile.LGU_SUBCHOICES)
